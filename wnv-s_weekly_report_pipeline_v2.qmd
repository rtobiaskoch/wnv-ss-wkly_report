...
Rscript config/config_weekly.R --input 1_input/w32 --year 2025 --week 32 --download T --update T
--push F
...
if(file_prefix %in% sheet_names(key_birds)) {
  # Either delete the existing sheet first
  sheet_delete(key_birds, sheet = file_prefix)
