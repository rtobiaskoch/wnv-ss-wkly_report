...
3.  check the quanstudio eds files on diomni pcr software on thermofisher and look to see if any
    inconclusives with a Ct are positive or negative. If any are negative add them to the
    amp_inconclusive_negative database sheet in the google drive
...
Rscript config/config_weekly.R --input 1_input/w35 --year 2025 --week 35 --download T --update T
--push T
